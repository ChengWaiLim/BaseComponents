...
public class FancyAlertDialog {
    ...
    private int icon;
    private hk.com.chengwailim.fancyalertdialog.Icon visibility;
    private hk.com.chengwailim.fancyalertdialog.Animation animation;
    private hk.com.chengwailim.fancyalertdialog.FancyAlertDialogListener pListener,nListener;
